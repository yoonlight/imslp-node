...
var Chrome = /** @class */ (function () {
    ...
    Chrome.prototype.methodName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, page, imslpUrl, title, navigationPromise, v, content, contents;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, puppeteer.launch({ headless: false, devtools: true })];
                    case 1:
                        _a.browser = _b.sent();
                    ...
                    case 8:
                        content = _b.sent();
                        contents = content.filter(function (x) { return _this.result.hasOwnProperty(Object.keys(x)[0]) ? Object.keys(x)[0] : undefined; });
                        contents.map(function (content) {
                            var key = Object.keys(content)[0];
                            var value = Object.values(content);
                            _this.result[key] = value;
                        });
                        return [2 /*return*/];
                }
            });
